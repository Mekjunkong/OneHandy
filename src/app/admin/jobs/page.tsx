  ...
  return (
    <main className="min-h-screen bg-cream">
      ...
      <div className="max-w-6xl mx-auto px-8 py-10">
        <h1 className="font-display text-2xl font-semibold text-ink mb-2">Sample Jobs</h1>
        <p className="text-sm text-muted mb-8">Mock records for Phase 1 admin UI review only.</p>
        <JobsTable />
      </div>
    </main>
  );

        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-sm leading-relaxed max-w-xs text-white/50">
              Your home, handled. Vetted technicians, English support, and secure payment for expat homeowners in Chiang Mai.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link href="/book" className="hover:text-gold transition-colors">Book a Service</Link></li>
            </ul>
          </div>
        </div>
